...
def main() -> None:
    ...
    documents_file = "examples/conditionalqa_documents.json"
    processed_docs_file = "examples/conditionalqa_documents_processed.json"
    ...
    questions_file = "examples/conditionalqa_train.json"
    processed_questions_file = "examples/conditionalqa_train_processed.json"
    ...
    pot = ProofOfThought(
        ...
        backend="smt2",
        max_attempts=3,
        cache_dir="output/programs_smt2_conditionalqa",
        z3_path="z3",
    )
    ...
    evaluator = EvaluationPipeline(
        ...
        output_dir="output/evaluation_results_conditionalqa",
        num_workers=10,
    )
    ...
    # Print results
    print("\n" + "=" * 80)
    print("CONDITIONALQA BENCHMARK RESULTS (SMT2 Backend + Azure GPT-5)")
    print("=" * 80)
