...
parquet_file = "examples/proofwriter_test.parquet"
processed_file = "examples/proofwriter_test_processed.json"
...
pot = ProofOfThought(
    ...
    backend="smt2",
    max_attempts=3,
    cache_dir="output/programs_smt2_proofwriter",
    z3_path="z3",
)
...
evaluator = EvaluationPipeline(
    ...
    output_dir="output/evaluation_results_proofwriter",
    num_workers=10,
)
...
# Print results
print("\n" + "=" * 80)
print("PROOFWRITER BENCHMARK RESULTS (SMT2 Backend + Azure GPT-5)")
print("=" * 80)
